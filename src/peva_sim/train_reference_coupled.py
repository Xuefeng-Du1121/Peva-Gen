...
from .reference_features import LatentFeatureAdapter as TransportFeatureAdapter
...
def main():
    ...
    metadata={"version":"coupled_reference128_pilot_v1","status":"Gaussian-reference coupled development; not complete PEVA-Gen",
